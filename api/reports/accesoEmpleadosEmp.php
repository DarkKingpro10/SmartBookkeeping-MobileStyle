...
// Se envía el documento al correo usando la libreria
$doc =  $pdf->output('s', 'accesoEmpleados.pdf');//definimos el pdf
...
$correo = $rec->obtenerCorreoEmp($_SESSION['id_usuario']);//correo del empleado
$pdf = $doc;//obtenemos el pdf
$reportn = 'Empleados sin accesos.pdf';
$cliente =  $_SESSION['nombreUsuario'].''. $_SESSION['apellidoUsuario'];//seteamos el cliente
$body = '<!DOCTYPE html
